...
public class listitem_arrayadapter extends ArrayAdapter<String> {
    String [][] item_name;
    String[][]item_os;
    String [][]item_price;
    int [] item_img;
    ...
    public listitem_arrayadapter(@NonNull Context context, String[][] item_name, String[][] item_os, String [][]item_price, int[] item_img) {
        super(context, R.layout.list_detail_item);
    ...
    public View getView(int position, @Nullable View vw, @NonNull ViewGroup parent) {
        ...
        if(vw==null){
            ...
            vw=inflater.inflate(R.layout.list_detail_item,parent,false);
